	...
	describe('validate', () => {
		describe('schema validation', () => {
			...
			it('it should throw error that name is missing', () => {
				...
				expect(() => transactionAsset.validate(context)).toThrow('NFT init value is too low.');
			});
		});
	});
	...
	describe('apply', () => {
		...
		describe('valid cases', () => {
			it('should create new nft', async () => {
				...
				const updatedSender: accountInterface = await stateStore.account.get(account.address);
